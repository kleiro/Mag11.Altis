...
_player createDiaryRecord ["Diary", ["Autorotation Practice", "Four UH-1Y's at the main airfield contain autorotation and rock-out scripts for practicing with a damaged helicopter."]];
